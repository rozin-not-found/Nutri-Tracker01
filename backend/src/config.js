...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '8af36ee1dd0c808972bf6e507711bb8e',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'Nutri-Tracker01 <app@flatlogic.app>',
  ...
  project_uuid: 'ce2bc75e-f016-4945-b817-41e7334cd1a5',
  flHost:
...
config.pexelsQuery = 'healthy food on table';
config.host =
