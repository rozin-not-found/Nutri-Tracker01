...
export default function PricingSection({
  ...
  return (
    <section
      className={` ${withBg ? 'bg-pastelEmeraldTheme-pricing' : `${bgColor}`}`}
    >
        ...
        <div className='space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0'>
          ...
          <div
            className={`flex flex-col p-6 h-full mx-auto max-w-lg ${shadow} ${
              withBg ? `${bgColor}` : 'bg-pastelEmeraldTheme-pricing'
            } ${
            ...
            <div className='flex-grow'>
              <h3 className=' text-2xl font-semibold'>
                ...
                <span
                  className={`${
                    corners != 'rounded-full' ? `${corners}` : 'rounded-3xl'
                  } ml-2 bg-pastelEmeraldTheme-buttonColor text-pastelEmeraldTheme-outsideCardColor font-semibold  text-sm p-1 ${navBarItemLabelActiveColorStyle} `}
                >
                  MOST POPULAR
                </span>
              </h3>
