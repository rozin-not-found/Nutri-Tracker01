...
const HeroTextCenter = ({ mainText, subTitle, buttonText, textSecondary }) => (
  <div className='relative w-full h-auto flex items-center justify-center text-center'>
    <div className='absolute top-0 mt-2 left-0 w-full h-2/3 bg-gradient-to-b from-pastelEmeraldTheme-buttonColor to-transparent filter blur-lg opacity-25 z-0'></div>
